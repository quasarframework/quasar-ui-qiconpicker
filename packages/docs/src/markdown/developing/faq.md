...
No. QIconPicker v3 targets Quasar CLI Vite 3 and requires `@quasar/app-vite` >=3.0.0-beta.43. If your app still uses `@quasar/app-webpack`, migrate the app to Quasar CLI Vite before installing QIconPicker v3.
