...
Use this guide to migrate from QIconPicker v2.x to QIconPicker v3.0.0 beta.
...
```html
<link
  href="https://cdn.jsdelivr.net/npm/@quasar/quasar-ui-qiconpicker@3.0.0-beta.0/dist/index.min.css"
  rel="stylesheet"
/>
<script src="https://cdn.jsdelivr.net/npm/@quasar/quasar-ui-qiconpicker@3.0.0-beta.0/dist/index.umd.min.js"></script>
```
