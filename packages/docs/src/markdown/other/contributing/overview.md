...
Contributions are not limited to code. We also encourage feedback, documentation, new design, and tools. And, we also encourage [sponsorship](/other/contributing/sponsor), especially if you are using QIconPicker in a business endeavor.
