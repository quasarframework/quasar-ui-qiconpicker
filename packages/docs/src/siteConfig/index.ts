  ...
  children: [
    {
      name: 'GitHub',
      icon: fabGithub,
      path: `https://github.com/quasarframework/quasar-ui-qiconpicker/tree/${repoBranch}`,
      external: true,
    },
    {
      name: 'X (Twitter)',
...
const docsMenus: SiteMenuItem[] = [
  ...
  },
  {
    ...
    mq: 600,
    children: [
      { name: 'Using QIconPicker', path: '/developing/using-qiconpicker' },
...
const config: SiteConfig = {
  lang: 'en-US',
  title: productName,
  description: 'Icon picker for Vue and Quasar applications',
  theme: 'doc',
  version,
  copyright: {
  ...
  githubEditRootSrc: `https://github.com/quasarframework/quasar-ui-qiconpicker/edit/${repoBranch}/packages/docs/src`,
  githubSourceRootSrc: `https://github.com/quasarframework/quasar-ui-qiconpicker/tree/${repoBranch}/packages/docs/src`,
  codepen: {
    jsPreProcessor: 'typescript',
    titleSuffix: `QIconPicker v${version}`,
    cssExternal: [
      `https://cdn.jsdelivr.net/npm/@quasar/quasar-ui-qiconpicker@${codepenPackageVersion}/dist/index.min.css`,
    ],
    jsExternal: [
      `https://cdn.jsdelivr.net/npm/@quasar/quasar-ui-qiconpicker@${codepenPackageVersion}/dist/index.umd.min.js`,
    ],
    globalPackages: [
      {
        packageName: '@quasar/quasar-ui-qiconpicker',
        globalName: '(globalThis as any).QIconPicker',
      },
    ],
    jsSetup: 'app.use((globalThis as any).QIconPicker)',
  },
  license: {
    label: 'MIT License',
    link: `https://github.com/quasarframework/quasar-ui-qiconpicker/blob/${repoBranch}/LICENSE`,
  },
  privacy: {
    label: 'Contact',
    link: '/other/contact',
