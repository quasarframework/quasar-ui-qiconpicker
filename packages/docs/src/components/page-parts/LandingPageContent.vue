<template>
  <section class="landing-page markdown-brand">
    ...
    <div class="byline">
      <p>
        Add icon selection to Quasar applications with searchable icon sets, pagination, custom
        collections, and slot-based rendering.
      </p>
    </div>
    ...
    <div class="byline">
      <p>
        ...
        <a href="https://github.com/quasarframework/quasar-ui-qiconpicker" target="_blank">
          QIconPicker GitHub repo
        </a>
        and the
    ...
    <div class="byline">
      <p>
        ...
        assistance, please reach out through the QIconPicker repository or GitHub Discussions.
      </p>
    </div>
  </section>
</template>
