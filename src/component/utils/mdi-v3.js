const fonts = [
  ...
  { name: 'mdi-book-multiple-minus' },
  { name: 'mdi-book-multiple-plus' },
  { name: 'mdi-book-multiple-remove' },
  { name: 'mdi-book-multiple-variant' },
  { name: 'mdi-book-open' },
  ...
  { name: 'mdi-chart-pie' },
  { name: 'mdi-chart-scatterplot-hexbin' },
