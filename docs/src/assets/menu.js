...
const menu = [
  {
    name: 'All about QIconPicker',
    path: 'all-about-qiconpicker',
    expanded: false,
    children: [
      {
        name: 'What is QIconPicker',
        path: 'what-is-qiconpicker'
      },
      {
  ...
  },
  {
    ...
    children: [
      {
        name: 'Using QIconPicker',
        path: 'using-qiconpicker'
      }
    ]
  },
  {
    ...
    children: [
      {
        name: 'GitHub',
        external: true,
        path: 'https://github.com/quasarframework/quasar-ui-qiconpicker',
        rightIcon: biGithub
      },
      {
        name: 'Twitter',
